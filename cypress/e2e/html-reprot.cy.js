...
//First, install mochawesome library ( npm install mochawesome --save-dev)
//Second, install (npm mochawesome-merge)
...
reporterOptions:{
 ...
 //Fifth, run (npx cpyress run --reporter mochawesome)
 ...
 //Run ( npx marge .\report1.json --reportDir .\cpyress\reports )